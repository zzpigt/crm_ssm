                    ...
                    <TR>
                        <TD>
                            <TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
                                ...
                                <TR>
                                    <TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/linkman/list.action"
                    ...
                    <TR>
                        <TD>
                            <TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
                                ...
                                <TR>
                                    <TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/saleVisit/list.action"
                    ...
                    <TR>
                        <TD>
                            <TABLE id=table_4 style="DISPLAY: none" cellSpacing=0
                                ...
                                <TBODY>
                                <TR>
                                    <TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/customer/industryCount.action"
                                                           target=main>－客户行业统计</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/customer/sourceCount.action"
                    ...
                    <TR>
                        <TD>
                            <TABLE id=table_6 style="DISPLAY: none" cellSpacing=0
                                ...
                                <TBODY>
                                <TR>
                                    <TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/role/list.action"
                                                           target=main>－角色管理</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/user/list.action"
