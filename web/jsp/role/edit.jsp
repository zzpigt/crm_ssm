...
<LINK href="${pageContext.request.contextPath }/css/Manage.css" type=text/css
	...
	<script type="text/javascript">
        loadDictSelect("006", "custLevel", "custLevel", ${customer.custLevel});
        loadDictSelect("002", "custSource", "custSource",${customer.custSource});
        loadDictSelect("001", "custIndustry", "custIndustry",${customer.custIndustry});
	</script>
...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/customer/edit.action"
		method=post>
