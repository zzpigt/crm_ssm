...
<head>
    ...
    <script type="text/javascript">
        loadDictSelect("006", "custLevel", "custLevel");
        loadDictSelect("002", "custSource", "custSource");
        loadDictSelect("001", "custIndustry", "custIndustry");
    </script>
    ...
    <TABLE cellSpacing=0 cellPadding=0 width="98%" border=0>
        ...
        <TR>
            ...
            <TD vAlign=top width="100%" bgColor=#ffffff>
                ...
                <input type="text" style="display:none;" name="custUserId"
                       value="${pageContext.session.getAttribute("user").userId}"/>
