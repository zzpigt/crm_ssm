											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="linkman.lkmName" value="${queryVo.linkman.lkmName}"></TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
													<a href="${pageContext.request.contextPath }/linkman/toEdit.action?id=${linkman.lkmId}">修改</a>
													&nbsp;&nbsp;
